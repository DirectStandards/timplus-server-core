...
public class DefaultCertificateProvider_getCertificatesTest extends SpringDataBaseTest
{
	...
	@Test
	public void testGetCertificates_certAvailable_assertRetrieved() throws Exception
	{
		final Collection<Certificate> certs = certProv.getCertificates();
