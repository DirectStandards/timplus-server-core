                    ...
                    if (session.getStatus() == Session.STATUS_AUTHENTICATED) {
                        ...
                        // If inband registration is not allowed, return an error.
                            ...
                            if (user.getUsername().equalsIgnoreCase(username)) {
                                ...
                                newUser = userManager.createUser(username, password, null, email, domain);
                            }
                            else {
                        ...
                        // information was not provided
                            ...
                            newUser = userManager.createUser(username, password, name, email, DomainResolver.resolveUserDomain(username));
                        }
                    }
