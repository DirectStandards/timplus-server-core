...
public class AdminManager {
     ...
     */
    public void addAdminAccount(String username, String domain) 
    {
        if (adminList == null) {
            loadAdminList();
        }
        JID userJID = XMPPServer.getInstance().createJID(username, domain, null);
     ...
     */
    public void removeAdminAccount(String username, String domain) {
        if (adminList == null) {
            loadAdminList();
        }
        JID userJID = XMPPServer.getInstance().createJID(username, domain, null);
    ...
    public void setAdminUsers(List<String> usernames) {
        ...
        {
            admins.add(XMPPServer.getInstance().createJID(username, DomainResolver.resolveUserDomain(username), null));
        }
