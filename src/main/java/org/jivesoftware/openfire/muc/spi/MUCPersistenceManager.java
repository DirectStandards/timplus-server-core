...
public class MUCPersistenceManager {
    ...
    public static void loadFromDB(LocalMUCRoom room) {
        ...
        ResultSet rs = null;
        try {
            Long serviceID = XMPPServer.getInstance().getMultiUserChatManager().getMultiUserChatServiceID(room.getMUCService().getServiceName(), room.getMUCService().getDomain());
            con = DbConnectionManager.getConnection();
    ...
    public static void saveToDB(LocalMUCRoom room) {
        ...
        try {
            ...
            if (room.wasSavedToDB()) {
                ...
                pstmt.setLong(1, XMPPServer.getInstance().getMultiUserChatManager().getMultiUserChatServiceID(room.getMUCService().getServiceName(), room.getMUCService().getDomain()));
                pstmt.setLong(2, room.getID());
    ...
    public static Collection<LocalMUCRoom> loadRoomsFromDB(MultiUserChatService chatserver, Date cleanupDate, PacketRouter packetRouter) {
        Long serviceID = XMPPServer.getInstance().getMultiUserChatManager().getMultiUserChatServiceID(chatserver.getServiceName(), chatserver.getDomain());
     ...
     */
    public static String getProperty(String subdomain, String domain, String name) {    	
        final MUCServiceProperties props = propertyMaps.computeIfAbsent( MultiUserChatManager.toFQDN(subdomain,  domain), k -> new MUCServiceProperties(subdomain, domain));
     ...
     * @return the property value specified by name.
     */
    public static String getProperty(String subdomain, String domain, String name, String defaultValue) {
        final String value = getProperty(subdomain, domain, name);
        if (value != null) {
            return value;
        } else {
            return defaultValue;
     ...
     */
    public static int getIntProperty(String subdomain, String domain, String name, int defaultValue) {
        String value = getProperty(subdomain, domain, name);
        if (value != null) {
            try {
     ...
     * @return the property value specified by name or {@code defaultValue}.
     */
    public static long getLongProperty(String subdomain, String domain, String name, long defaultValue) {
        String value = getProperty(subdomain, domain, name);
        if (value != null) {
            try {
     ...
     */
    public static boolean getBooleanProperty(String subdomain, String domain, String name) {
        return Boolean.valueOf(getProperty(subdomain, domain, name));
    }
     ...
     *      Otherwise {@code false} is returned.
     */
    public static boolean getBooleanProperty(String subdomain, String domain, String name, boolean defaultValue) {
        String value = getProperty(subdomain, domain, name);
        if (value != null) {
     ...
     */
    public static List<String> getPropertyNames(String subdomain, String domain, String parent) {
        final MUCServiceProperties props = propertyMaps.computeIfAbsent( MultiUserChatManager.toFQDN(subdomain,  domain), k -> new MUCServiceProperties(subdomain, domain));
     ...
     */
    public static List<String> getProperties(String subdomain, String domain, String parent) {
        final MUCServiceProperties props = propertyMaps.computeIfAbsent( MultiUserChatManager.toFQDN(subdomain,  domain), k -> new MUCServiceProperties(subdomain, domain));
        Collection<String> propertyNames = props.getChildrenNames(parent);
        List<String> values = new ArrayList<>();
        for (String propertyName : propertyNames) {
            String value = getProperty(subdomain, domain, propertyName);
            if (value != null) {
                values.add(value);
            }
        }
     ...
     */
    public static List<String> getPropertyNames(String subdomain, String domain) {
        final MUCServiceProperties props = propertyMaps.computeIfAbsent( MultiUserChatManager.toFQDN(subdomain,  domain), k -> new MUCServiceProperties(subdomain, domain));
     ...
     */
    public static void setProperty(String subdomain, String domain, String name, String value) {
        MUCServiceProperties properties = propertyMaps.get(MultiUserChatManager.toFQDN(subdomain, domain));
        if (properties == null) {
            properties = new MUCServiceProperties(subdomain, domain);
        }
        properties.put(name, value);
        propertyMaps.put(subdomain, properties);
    }

    public static void setLocalProperty(String subdomain, String domain, String name, String value) {
        MUCServiceProperties properties = propertyMaps.get(MultiUserChatManager.toFQDN(subdomain, domain));
        if (properties == null) {
            properties = new MUCServiceProperties(subdomain, domain);
        }
        properties.localPut(name, value);
        propertyMaps.put(MultiUserChatManager.toFQDN(subdomain, domain), properties);
    }
    ...
    * @param subdomain the subdomain of the service to set properties for
     ...
     */
    public static void setProperties(String subdomain, String domain, Map<String, String> propertyMap) {
        MUCServiceProperties properties = propertyMaps.get(MultiUserChatManager.toFQDN(subdomain, domain));
        if (properties == null) {
            properties = new MUCServiceProperties(subdomain, domain);
        }
     ...
     */
    public static void deleteProperty(String subdomain, String domain, String name) {
        MUCServiceProperties properties = propertyMaps.get(MultiUserChatManager.toFQDN(subdomain, domain));
        if (properties == null) {
            properties = new MUCServiceProperties(subdomain, domain);
        }
    ...
    public static void deleteLocalProperty(String subdomain, String domain, String name) {
        MUCServiceProperties properties = propertyMaps.get(MultiUserChatManager.toFQDN(subdomain, domain));
        if (properties == null) {
            properties = new MUCServiceProperties(subdomain, domain);
        }
