...
public class LocalMUCRoom implements MUCRoom, GroupEventListener {
    ...
    public LocalMUCRoom(MultiUserChatService chatservice, String roomname, PacketRouter packetRouter) {
        ...
        this.canOccupantsChangeSubject = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.canOccupantsChangeSubject", false);
        this.maxUsers = MUCPersistenceManager.getIntProperty(mucService.getServiceName(), mucService.getDomain(), "room.maxUsers", 30);
        this.publicRoom = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.publicRoom", false);
        this.persistent = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.persistent", false);
        this.moderated = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.moderated", false);
        this.membersOnly = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.membersOnly", true);
        this.canOccupantsInvite = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.canOccupantsInvite", true);
        this.canAnyoneDiscoverJID = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.canAnyoneDiscoverJID", true);
        this.logEnabled = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.logEnabled", true);
        this.loginRestrictedToNickname = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.loginRestrictedToNickname", false);
        this.canChangeNickname = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.canChangeNickname", false);
        this.registrationEnabled = MUCPersistenceManager.getBooleanProperty(mucService.getServiceName(), mucService.getDomain(), "room.registrationEnabled", false);
...
//            }
    ...
    public String canSendPrivateMessage() {
        return canSendPrivateMessage == null ? "none" : canSendPrivateMessage;
    }
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        String domain = ExternalizableUtil.getInstance().readSafeUTF(in);
        mucService = XMPPServer.getInstance().getMultiUserChatManager().getMultiUserChatService(subdomain, domain);
