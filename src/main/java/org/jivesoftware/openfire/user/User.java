...
public class User implements Cacheable, Externalizable, Result {
     ...
     */
    public User(String username, String name, String email, String domain, Date creationDate,
    ...
    /**
     * Returns the domain this user is associated to
     * 
    ...
    public Roster getRoster() {
        try {
            return XMPPServer.getInstance().getRosterManager().getRoster(username, domain);
        }
        catch (UserNotFoundException unfe) {
            Log.error(unfe.getMessage(), unfe);
            return null;
    ...
    public boolean equals(Object object) {
        ...
        if (object != null && object instanceof User) {
            return username.equals(((User)object).getUsername()) && domain.equals(((User)object).getDomain());
        }
        else {
            return false;
        }
