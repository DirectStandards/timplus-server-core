...
public class PrivacyList implements Cacheable, Externalizable {
    ...
    public PrivacyList(String username, String domain, String name, boolean isDefault, Element listElement) {
        this.userJID = XMPPServer.getInstance().createJID(username, domain, null, true);
        this.name = name;
