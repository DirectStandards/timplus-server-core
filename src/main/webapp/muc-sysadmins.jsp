...
<%  // Get parameters
    ...
    if (!webManager.getMultiUserChatManager().isServiceRegistered(mucname, mucdomain)) {
    ...
    // Get muc server
    MultiUserChatService mucService = webManager.getMultiUserChatManager().getMultiUserChatService(mucname, mucdomain);
